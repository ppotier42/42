...
/*   Updated: 2023/09/26 15:54:42 by ppotier          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// echo.c
// tokenize.c
t_tokenizer	*toker_init(char *input, int status, t_env *envcpy);
t_token		**token_parse(t_tokenizer *tok);
t_token		**tokenizer_input(char *input, int status, t_env *envcpy);
...
// ast_execute_cmd.c
void		ast_execute_cmd(t_node *root, t_env *envcpy);
// get_env.c
...
int			ft_exit(char **argv, t_env *envcpy);
